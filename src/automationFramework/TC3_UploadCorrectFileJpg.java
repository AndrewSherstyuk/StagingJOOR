...
public class TC3_UploadCorrectFileJpg extends TC_Base {

	public static void main(String[] args) throws InterruptedException {

		TC3_UploadCorrectFileJpg test = new TC3_UploadCorrectFileJpg();
		test.login();
		test.uploadCorrectFileJpgTest();
		test.logout();
		test.close();
	}

	public void uploadCorrectFileJpgTest() throws InterruptedException {
